...
public class LoginChat extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String pass = String.valueOf(txtPs.getPassword());
        String tenTk = txtUs.getText();
        try {
            ...
            do {
                ...
                guiDuLieu("KT_Login|" + tenTk + "|" + pass);
                result = dis.readInt();
                if (result == 1) {
                    GiaoDienChat gdc = new GiaoDienChat();
                    GiaoDienChat.name=tenTk;
                    gdc.setVisible(true);
   ...
   public void exit(){
    ...
    public void guiDuLieu(String mess) {
        try {
            dos = new DataOutputStream(socket.getOutputStream());
            dos.writeUTF(mess);
        } catch (IOException ex) {
