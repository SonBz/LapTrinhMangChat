    ...
    public GiaoDienChat() {
        ...
        listModel = new DefaultListModel<>();  
         ...
         try {            
           ...
           Logger.getLogger(GiaoDienChat.class.getName()).log(Level.SEVERE, null, ex);
       }
       ...
       Thread thread=new Thread(new Runnable() {
           ...
           public void run() {
             ...
             while(true){               
                 ...
                 String hit,cmd,messa;  
                 String str;
                 try {
                     dis=new DataInputStream(socket.getInputStream());                                   
                     messa=dis.readUTF();
                     tokenizer=new StringTokenizer(messa, "|");
   ...
   public void exit(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaoDienChat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GiaoDienChat().setVisible(true);
